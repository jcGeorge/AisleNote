import React, { useEffect, useRef, useState, type CSSProperties, type KeyboardEvent as ReactKeyboardEvent, type MouseEvent as ReactMouseEvent } from 'react'
import { NoteLocationPicker, type NoteLocationPickerValue } from '../notes/NoteLocationPicker'
import { ShortcutMenuSettingsPanel } from '../settings/ShortcutMenuSettingsPanel'
    ...
    if (!isPreviewReference) {
      return (
        <div className="note-reference-heading-picker" role="group" aria-label="Link start">
          <div className="note-reference-heading-primary">
            <span className="note-reference-heading-label">link starts at</span>
            <div className="note-reference-heading-start-buttons">
              <button
                type="button"
          ...
          {resolved.headings.length > 0 && (
            <div className="note-reference-heading-list">
              <span className="note-reference-heading-separator" aria-hidden="true" />
  ...
  return (
    ...
    >
      ...
      >
        ...
        {modal.type === 'shortcut-menu-settings' && (
          <ShortcutMenuSettingsPanel operations={shortcutMenuOperations} onChange={onShortcutMenuOperationsChange} />
        )}
        {modal.type === 'sort-tabs' && (
