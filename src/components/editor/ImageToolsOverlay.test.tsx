...
describe('ImageToolsOverlay transform menu', () => {
  ...
  it('uses shared theme tokens and 20% larger controls for image tool buttons', () => {
    ...
    expect(baseCss).toContain('--image-tool-btn-border: var(--action-chip-border);')
    expect(baseCss).toContain('--image-tool-btn-bg: var(--action-chip-bg);')
    expect(baseCss).toContain('--image-tool-btn-text: var(--action-chip-text);')
    expect(baseCss).toContain('--image-tool-crop-border: var(--app-primary);')
    expect(buttonRule).toContain('border: 1px solid var(--image-tool-btn-border);')
    expect(buttonRule).toContain('background: var(--image-tool-btn-bg);')
    expect(buttonRule).toContain('color: var(--image-tool-btn-text);')
    ...
    expect(buttonHoverRule).toContain('border-color: var(--image-tool-btn-hover-border);')
    expect(buttonHoverRule).toContain('background: var(--image-tool-btn-hover-bg);')
    expect(buttonHoverRule).toContain('color: var(--image-tool-btn-hover-text);')
    expect(buttonActiveRule).toContain('border-color: var(--image-tool-btn-active-border);')
    expect(buttonActiveRule).toContain('background: var(--image-tool-btn-active-bg) !important;')
    expect(buttonActiveRule).toContain('color: var(--image-tool-btn-active-text);')
    expect(cropSelectRule).toContain('height: 2.1rem;')
    expect(cropSelectRule).toContain('max-width: 13.2rem;')
    expect(cropSelectRule).toContain('border: 1px solid var(--image-tool-btn-border);')
    expect(cropSelectRule).toContain('background: var(--image-tool-btn-bg);')
    expect(cropSelectRule).toContain('color: var(--image-tool-btn-text);')
    expect(cropSelectRule).toContain('font-size: 1.08em;')
    expect(cropSelectRule).toContain('padding: 0 1.92rem 0 0.54rem;')
    expect(cropSelectHoverRule).toContain('border-color: var(--image-tool-btn-hover-border);')
    expect(cropSelectHoverRule).toContain('background: var(--image-tool-btn-hover-bg);')
    expect(cropSelectHoverRule).toContain('color: var(--image-tool-btn-hover-text);')
    ...
    expect(copyIconLayerRule).toContain('background: var(--image-tool-btn-bg);')
  })

  it('uses svg resize icons while preserving striped crop edge handles', () => {
    const css = readFileSync(new URL('../../styles/editor-shell.css', import.meta.url), 'utf8')
    const cheeseCss = readFileSync(new URL('../../styles/themes/cheese.css', import.meta.url), 'utf8')
    ...
    const cropHandlesRule = extractRule(css, '.inline-crop-edge-handle,\n.inline-crop-resize-handle')
    ...
    const resizeHandleHoverRule = extractRule(css, '.image-resize-handle:hover,\n.image-resize-handle:focus-visible')
    const cropHandlesHoverRule = extractRule(
      css,
      '.inline-crop-edge-handle:hover,\n.inline-crop-edge-handle:focus-visible,\n.inline-crop-resize-handle:hover,\n.inline-crop-resize-handle:focus-visible',
    )
    const cheeseResizeHandleRule = extractRule(cheeseCss, '.theme-cheese .image-resize-handle')
    const cheeseCropCornerRule = extractRule(cheeseCss, '.theme-cheese .inline-crop-resize-handle')
    const cheeseCropEdgeRule = extractRule(cheeseCss, '.theme-cheese .inline-crop-edge-handle')
    ...
    expect(resizeIconRule).toContain('width: 19px;')
    expect(resizeIconRule).toContain('height: 19px;')
    expect(resizeIconBackgroundRule).toContain('fill: transparent;')
    expect(resizeIconBackgroundRule).toContain('stroke: none;')
    expect(cropIconBackgroundRule).toBe('')
    expect(css).toContain('border: 2px solid var(--image-tool-crop-border);')
    expect(resizeHandleRule).toContain('width: 26px;')
    expect(resizeHandleRule).toContain('height: 26px;')
    expect(resizeHandleRule).toContain('border: 1px solid var(--image-tool-btn-border);')
    expect(resizeHandleRule).toContain('background: var(--image-tool-btn-bg);')
    expect(resizeHandleRule).toContain('box-shadow: var(--image-tool-btn-shadow);')
    expect(resizeHandleRule).toContain('color: var(--image-tool-btn-text);')
    expect(resizeHandleHoverRule).toContain('border-color: var(--image-tool-btn-hover-border);')
    expect(resizeHandleHoverRule).toContain('background: var(--image-tool-btn-hover-bg);')
    expect(resizeHandleHoverRule).toContain('color: var(--image-tool-btn-hover-text);')
    expect(cropCornerRule).toContain('width: 26px;')
    expect(cropCornerRule).toContain('height: 26px;')
    expect(cropCornerRule).toContain('border: 1px solid var(--image-tool-btn-border);')
    expect(cropCornerRule).toContain('background: var(--image-tool-btn-bg);')
    expect(cropCornerRule).toContain('box-shadow: var(--image-tool-btn-shadow);')
    expect(cropCornerRule).toContain('color: var(--image-tool-btn-text);')
    expect(cropHandlesRule).toContain('border: 1px solid var(--image-tool-handle-border);')
    expect(cropHandlesRule).toContain('background: var(--image-tool-handle-bg);')
    expect(cropHandlesRule).toContain('color: var(--image-tool-handle-stripe);')
    expect(cropHandlesHoverRule).toContain('border-color: var(--image-tool-btn-hover-border);')
    expect(cropHandlesHoverRule).toContain('background: var(--image-tool-btn-hover-bg);')
    expect(cropHandlesHoverRule).toContain('color: var(--image-tool-btn-hover-text);')
    ...
    expect(css).toContain('currentColor 3px 4px')
    ...
    expect(cheeseResizeHandleRule).toBe('')
    expect(cheeseCropCornerRule).toBe('')
    expect(cheeseCropEdgeRule).toBe('')
    expect(cheeseCss).not.toContain('.theme-cheese .image-resize-handle::before')
    expect(cheeseCss).not.toContain('.theme-cheese .inline-crop-resize-handle::before')
    expect(cheeseCss).not.toContain('--image-tool-btn-bg')
    expect(lightResizeHandleRule).toBe('')
    expect(lightCropCornerRule).toBe('')
    expect(lightCropEdgeRule).toBe('')
    ...
    expect(lightCss).not.toContain('--image-tool-btn-bg')
  })
})
