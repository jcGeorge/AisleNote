...
describe('DataSectionSwitch', () => {
  it('renders the data section radios with the selected state', () => {
    ...
    expect(html).toContain('aria-checked="false" class="settings-segmented-option ">notebook</button>')
    expect(html).toContain('aria-checked="false" class="settings-segmented-option ">settings</button>')
    expect(html).toContain('aria-checked="true" class="settings-segmented-option is-selected">folder</button>')
