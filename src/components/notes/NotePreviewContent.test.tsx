...
describe('NotePreviewContent', () => {
  ...
  it('defines size, boundary, hidden-source, and internal scroll styles', () => {
    ...
    expect(editorShellCss).toContain('.aislenote-note-preview-widget-host')
    ...
    expect(editorShellCss).toContain('.aislenote-note-preview-widget-host:has(.note-preview-widget.is-action-menu-open)')
    ...
    expect(editorShellCss).not.toContain('.context-preview-editor-host.aislenote-rendered-markdown-surface > p')
    expect(editorShellCss).not.toContain('.context-preview-editor-host.aislenote-rendered-markdown-surface li > p')
    expect(editorShellCss).toContain('.note-preview-widget .context-bar-lower')
    expect(editorContentCss).not.toContain('.context-preview-editor-host.aislenote-rendered-markdown-surface')
    expect(editorContentCss).toContain('.aislenote-note-preview-source-block-hidden')
