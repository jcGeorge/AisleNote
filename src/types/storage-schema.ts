...
export const STORAGE_INTERNAL_DIR = '.tabs' as const
export const STORAGE_MANIFEST_FILE = 'manifest.json' as const
export const STORAGE_NOTEBOOK_INDEX_FILE = '.tabs/notebook-index.json' as const
export const STORAGE_NOTE_REGISTRY_FILE = '.tabs/note-registry.json' as const
export const STORAGE_TRASH_INDEX_FILE = '.tabs/trash-index.json' as const
export const STORAGE_EDITOR_STATE_FILE = '.tabs/editor-state.json' as const
export const STORAGE_FRONTMATTER_SETTINGS_FILE = '.tabs/frontmatter-settings.json' as const
export const STORAGE_APP_STATE_FILE = '.tabs/app-state.json' as const
