...
const CUSTOM_THEME_VARIABLE_BY_SLOT: Record<CustomThemePaletteSlot, `--${string}`> = {
  ...
  tooltipPrimary: '--custom-theme-tooltip-primary',
  tooltipSecondary: '--custom-theme-tooltip-secondary',
...
const BUILT_IN_OVERRIDE_VARIABLES_BY_SLOT: Partial<Record<CustomThemePaletteSlot, `--${string}`[]>> = {
  ...
  text: ['--app-text', '--app-text-heading', '--editor-text', '--editor-heading-text'],
  ...
  tagBg: ['--editor-tag-bg'],
  tooltipPrimary: ['--editor-toolbar-icon-primary'],
  tooltipSecondary: ['--editor-toolbar-icon-secondary'],
